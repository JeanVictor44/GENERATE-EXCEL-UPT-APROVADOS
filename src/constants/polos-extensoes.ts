export const POLOS_EXTENSOES = {
    ...
    Jacobina: [
        ...
        'Caldeirão Grande',
        'Jacobina – Quilombo Erê (Bairro da Bananeira)',
        'Miguel Calmon',
        'Piritiba',
        'Serrolândia',
        'Várzea Nova',
    ...
    Teixeira_de_Freitas: [
        'Prado – Comunidade indígena de Tauã',
        'Mucuri',
        'Teixeira de Freitas'
    ],
    Valença: [
        'Valença',
        'Terreiro Ile Axe Opo Oya Soju',
        'Camamu',
        'Mutuípe',
        'Jiquiriçá',
        'Vera Cruz',
